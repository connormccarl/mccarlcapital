  ...
  return (
    <main className="h-screen flex items-center justify-center">
      <div className="max-w-xl rounded overflow-hidden shadow-lg">
        <Image className="w-full" width={1200} height={350} src="/banner.png" alt="McCarl Capital" />
        <div className="px-6 py-4">
          <div className="flex font-bold text-xl mb-2">Connor McCarl</div>
          <p className="text-gray-300 text-base">
            Multifamily Real Estate Investor
          </p>
        </div>
        <div className="px-6 pt-4 pb-2 items-center grid grid-cols-1 md:grid-cols-2">
          <span className="flex items-center mb-5 md:mb-0">
          ...
          <span className="flex items-center md:ms-5">
            ...
            <a href="tel:+1(925)378-1728" className="text-white text-lg md:text-md ml-3 hover:text-[#AF8C52]">
              +1 (925) 378-1728
            </a>
          </span>
        </div>
