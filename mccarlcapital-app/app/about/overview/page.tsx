                ...
                <div className="mx-auto max-w-7xl px-6 pb-32 pt-0 sm:pt-60 lg:px-8 lg:pt-8">
                    <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                        <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                            ...
                            <Button
                                href="#"
                                className="rounded-md bg-[#AF8C52] mt-3 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#3d8627] hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#AF8C52]"
                            >
                                Invest Now
                            </Button>
