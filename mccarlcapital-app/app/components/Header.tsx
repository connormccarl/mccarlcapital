...
const about = [
  { name: 'Overview', description: 'Get to know us better', href: '#', icon: InformationCircleIcon },
  { name: 'Team', description: 'See who you are working with', href: '#', icon: UsersIcon },
  { name: 'Blog', description: 'Educate yourself and stay informed', href: '#', icon: NewspaperIcon },
]
const callsToAction = [
