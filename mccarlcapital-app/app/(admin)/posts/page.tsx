    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 flex">
          <Button onClick={getVideos} className="block rounded-md px-3 py-2 text-center text-sm font-semibold shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold ring-1 ring-inset ring-gray-300 hover:bg-gray-50 hover:text-black me-2">
              {loadingVideos ? 
          ...
          <Button
            type="button"
            className="block rounded-md bg-gold px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-green focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold hover:text-white"
          >
            Add Post
          </Button>
        </div>
                ...
                <tbody>
                  {videos.map((video: any, videoIdx: number) => (
                    <tr key={video.id}>
                      ...
                      >
                        <Link href="#" className="text-gold hover:text-green">
