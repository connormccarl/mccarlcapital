      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-8 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-1 md:gap-8 break-words">
              <div className='text-xs'>
                ...
                <br/><br/>
                For additional important risks, disclosures, and information, please visit <Link href="#">www.mccarlcapital.com/disclosures</Link>.</div>
              </div>
            </div>
          </div>
        </div>
        <div className="mt-10 border-t border-gray-900/10 pt-8 lg:flex lg:items-center lg:justify-between">
          <div>
            <h3 className="text-sm font-semibold leading-6 text-gray-900">Ready to Invest?</h3>
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Join our investor list to get notified everytime we have a new deal.
            </p>
          </div>
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div className="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
              <button
                type="submit"
                className="flex w-full items-center justify-center rounded-md bg-gold px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green hover:text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold"
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">
            &copy; {new Date().getFullYear()} McCarl Capital. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
